...
class BorrowerArticleDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root =inflater.inflate(R.layout.fragment_borrower_article_detail, container, false)
        ...
        txtback?.setOnClickListener {
            ...
            fragmentTransaction.replace(R.id.nav_host_fragment, BorrowerArticleFragment())
    ...
    private fun Article(ArticleID:String){
        ...
        var url: String = getString(R.string.root_url) + getString(R.string.articledetail_url) + ArticleID
