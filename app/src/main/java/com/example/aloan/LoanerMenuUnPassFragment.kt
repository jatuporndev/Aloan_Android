...
class LoanerMenuUnPassFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val root =inflater.inflate(R.layout.fragment_loaner_menu_un_pass, container, false)
    ...
    private fun showlist() {
        ...
        val url: String = getString(R.string.root_url) + getString(R.string.loaner_viewUnpass_url)+loanerID
    ...
    internal class Data(
        ...
        ,var Lastname: String,var imageProfile: String,var dateRe:String,var borrowlistID:String,var BorrowerID:String,
