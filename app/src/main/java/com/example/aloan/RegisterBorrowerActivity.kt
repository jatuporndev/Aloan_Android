...
class RegisterBorrowerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_register_borrower)
    ...
    {
        Log.d("rrr","1")
        var url: String = getString(R.string.root_url) + getString(R.string.registerBorrower_url)
        val okHttpClient = OkHttpClient()
